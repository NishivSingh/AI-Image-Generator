    ...
    <section className="max-w-7xl mx-auto">
      <div className="">
        ...
        <p className="mt-2 text-[#666e75] text-[14px]">
          create imaginative images through prompts and share them with the
          community section
        </p>
      </div>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">
            Once you have created the image, you can also share it with the
            community
          </p>
          <button
            type="submit"
          ...
          >
            {loading ? "Sharing..." : "Shared with community"}
          </button>
        </div>
      </form>
    </section>
